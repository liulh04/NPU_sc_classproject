...
public class Kernel implements CrowdKernel {
    ...
    public static String version(){
        return "CrowdOS CrowdKernel v1.04";
    }
    ...
    //The system provides PTMost, T_Most, T_Random, T_Weight and GGA_I algorithms by default. If necessary, you can choose them by yourself

    /**
     * The algoSelect function is used to select the algorithm that will be used by the scheduler.
     * The system provides PTMost, T_Most, T_Weight,T_Random and GGA_I algorithms by default.If you need, you can choose them by yourself.
